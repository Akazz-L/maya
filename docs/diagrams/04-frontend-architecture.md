...
graph TD
    ...
    subgraph components["components/ — presentational"]
        CMP["DocumentSidebar · DocumentEditor · ProseEditor<br/>RewriteLayer · RewritePrompt · RewriteReviewBar<br/>ChatPane · ProposalLayer · ProposalReviewBar<br/>ChapterToolbar · PlanView · IssuesView<br/>PlanForm · IssuesList · IssueCard<br/>ui/ — button, card, input, select, textarea"]
    end
