...
@pytest.mark.asyncio
async def test_checker_returns_empty_list_when_no_issues(base_state, sample_scene_plan):
...
@pytest.mark.asyncio
async def test_checker_returns_structured_issues(base_state, sample_scene_plan):
    base_state["scene_plan"] = sample_scene_plan
...
@pytest.mark.asyncio
async def test_checker_calls_claude_with_tool_choice(base_state, sample_scene_plan):
    base_state["scene_plan"] = sample_scene_plan
...
@pytest.mark.asyncio
async def test_checker_includes_draft_and_characters_in_prompt(base_state, sample_scene_plan):
    base_state["scene_plan"] = sample_scene_plan
